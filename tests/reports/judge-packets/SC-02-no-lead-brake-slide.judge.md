# Judge bundle — SC-02-no-lead-brake-slide
...
----- BEGIN PACKET -----
{
  ...
  "scenario_id": "SC-02-no-lead-brake-slide",
  "scenario_title": "Slide / no-lead-brake — lead-side post + recenter, not face mechanics",
  ...
  "scenario_fixture": {
    "id": "SC-02-no-lead-brake-slide",
    "title": "Slide / no-lead-brake — lead-side post + recenter, not face mechanics",
    "fault_ids": [
      "FAULT-SLIDE"
    ],
    "branch_ids": {
    ...
    "expected_expert_patterns": [
      "lead-side braking / vertical force timing",
      "external target / distal cue",
      "pressure shift sequencing pelvis-then-thorax"
    ],
    "forbidden_language_patterns": [
      "lateral hip slide stop",
      "keep your head down"
    ],
  ...
  "extracted_output": {
    ...
    "proof_cards": [
      {
        "fault_id": "FAULT-SLIDE",
        "branch_id": "no-lead-brake",
