# Judge bundle — SC-05-chunk-lowpoint-back
...
----- BEGIN PACKET -----
{
  ...
  "scenario_id": "SC-05-chunk-lowpoint-back",
  "scenario_title": "Chunk / low-point back — strike map first, no speed or pressure primary",
  ...
  "scenario_fixture": {
    "id": "SC-05-chunk-lowpoint-back",
    "title": "Chunk / low-point back — strike map first, no speed or pressure primary",
    "fault_ids": [
      "FAULT-CHUNK"
    ],
    "branch_ids": {
    ...
    "expected_expert_patterns": [
      ...
      "strike-pattern map for fat/thin",
      "no high-intent work while contact gate amber"
    ],
    "forbidden_language_patterns": [
      "hit down on it harder",
      "lean shaft forward"
    ],
  ...
  "extracted_output": {
    ...
    "proof_cards": [
      {
        "fault_id": "FAULT-CHUNK",
        "branch_id": "trail-hang",
